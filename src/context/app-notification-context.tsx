...
const LogoutState: UserNotificationType = [
  {title: '', message: '', endpoint: '', read: false},
];
...
export const useNotificationContext = (): NotificationManager =>
  React.useContext(NotificationContext);

const NotificationProvider = ({children}: Props): JSX.Element => {
  const [notificationData, setNotificationData] =
    useState<UserNotificationType>(initialState);
